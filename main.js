...
// API key 3300592266897990

const fetchAllSuperHero = async(searchText) => {
    let url = `https://www.superheroapi.com/api.php/3300592266897990/search/${searchText}`;
    try{
...
const showSuperheroDetails = (data) =>{
    ...
    document.querySelector('.biography').innerHTML = `
                                ...
                                <li>
                                    <span>First-apperence</span>
                                    <span>${data[0].biography['first-apperence']}</span>
                                </li>                                
                                <li>
                                    <span>publisher</span>
                                ...
                                `;
                                document.querySelector('.apperence').innerHTML = `
                                <li>
                                    <span>
